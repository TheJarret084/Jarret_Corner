//Combina FunkierPacher + UI + procesamiento ZIP y PNG+XML
// Contiene: FunkierPacker (rotated support) + UI para seleccionar archivos + quitar frames duplicados + creación de ZIP final
